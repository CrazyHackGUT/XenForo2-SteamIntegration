...
class Steam
{
    ...
    public function getNewsForApp($appId, $count = 3, $maxLength = 300)
    {
        return $this->getJsonResponse(
            "ISteamNews/GetNewsForApp/v0002/?appid=$appId&count=$count&maxlength=$maxLength"
        );
    }
    ...
    {
        return $this->getJsonResponse(
            "ISteamUserStats/GetGlobalAchievementPercentagesForApp/v0002/?gameid=$gameId"
        );
    }
    ...
    public function getPlayerSummaries($steamIds)
    {
        ...
        return $this->getJsonResponse(
            "ISteamUser/GetPlayerSummaries/v0002/?key=$this->key&steamids=$steamIds"
        );
    }
    ...
    {
        if (!in_array($relationship, ['friend', 'all']))
        {
            $relationship = 'all';
        }

        return $this->getJsonResponse(
            "ISteamUser/GetFriendList/v0001/?key=$this->key&steamid=$steamId&relationship=$relationship"
        );
    }
    ...
    {
        return $this->getJsonResponse(
            "ISteamUserStats/GetPlayerAchievements/v0001/?key=$this->key&appid=$appId&steamid=$steamId"
        );
    }
    ...
    {
        return $this->getJsonResponse(
            "IPlayerService/GetOwnedGames/v0001/?key=$this->key&steamid=$steamId"
        );
    }
    ...
    {
        return $this->getJsonResponse(
          "IPlayerService/IsPlayingSharedGame/v0001/?key=$this->key&steamid=$steamId&appid_playing=$appId"
        );
    }
    ...
    {
        return $this->getJsonResponse(
            "ISteamUserStats/GetSchemaForGame/v2/?key=$this->key&appid=$appId"
        );
    }
    ...
    public function getGameBans($steamIds)
    {
        ...
        return $this->getJsonResponse(
          "ISteamUser/GetPlayerBans/v1/?key=$this->key&steamids=$steamIds"
        );
    }
